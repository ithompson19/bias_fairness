...
def main():
    data_reader: DataReader = SmallAdultEven
...
def run_flip_rate_tests_race(data_reader: DataReader, col: str, val: str, flip_min: float, flip_max: float):
    ...
    flip_rate_test('Qualified', data_reader, flip_min, flip_max, column=col, neg_test=False)
    flip_rate_test('Unqualified', data_reader, flip_min, flip_max, column=col, pos_test=False)
    ...
    flip_rate_test(f'{val} Qualified', data_reader, flip_min, flip_max, column=col, val=val, neg_test=False)
    flip_rate_test(f'{val} Unqualified', data_reader, flip_min, flip_max, column=col, val=val, pos_test=False)
    flip_rate_test(f'Non-{val} Qualified', data_reader, flip_min, flip_max, column=col, val=f'-{val}', neg_test=False)
    flip_rate_test(f'Non-{val} Unqualified', data_reader, flip_min, flip_max, column=col, val=f'-{val}', pos_test=False)
...
def run_confidence_interval_tests_race(data_reader: DataReader, col: str, val: str, conf_min: float, conf_max: float, flip_rate: float):
    ...
    confidence_interval_test('Qualified', data_reader, conf_min, conf_max, flip_rate=(col, '', flip_rate, 0.0))
    confidence_interval_test('Unqualified', data_reader, conf_min, conf_max, flip_rate=(col, '', 0.0, flip_rate))
    ...
    confidence_interval_test(f'{val} Qualified', data_reader, conf_min, conf_max, flip_rate=(col, val, flip_rate, 0.0))
    confidence_interval_test(f'{val} Unqualified', data_reader, conf_min, conf_max, flip_rate=(col, val, 0.0, flip_rate))
    confidence_interval_test(f'Non-{val} Qualified', data_reader, conf_min, conf_max, flip_rate=(col, f'-{val}', flip_rate, 0.0))
    confidence_interval_test(f'Non-{val} Unqualified', data_reader, conf_min, conf_max, flip_rate=(col, f'-{val}', 0.0, flip_rate))
